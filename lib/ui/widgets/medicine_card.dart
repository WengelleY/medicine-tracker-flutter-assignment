      ...
      onTap: () => Navigator.push(
        ...
        MaterialPageRoute(
          builder: (_) => BlocProvider.value(
            ...
            child: MedicineDetailPage(medicine: medicine),
          ),
        ),
      ),
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: isTaken ? _takenGreen.withValues(alpha: 0.3) : _paleCyan,
            width: 1.5,
          ),
          boxShadow: [
            BoxShadow(
              color: _deepTeal.withValues(alpha: 0.05),
              blurRadius: 8,
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        _infoChip(Icons.colorize_rounded, medicine.dosage),
                        const SizedBox(width: 8),
                        _infoChip(Icons.access_time_rounded, medicine.time),
                      ],
                    ),
                  ],
                ),
  ...
  Widget _infoChip(IconData icon, String label) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Icon(icon, size: 11, color: _deepTeal),
